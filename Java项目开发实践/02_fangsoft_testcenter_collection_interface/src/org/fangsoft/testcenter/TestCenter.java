...
import org.fangsoft.testcenter.dao.impl.CustomerDaoImpl;
import org.fangsoft.testcenter.dao.impl.QuestionDaoImpl;
import org.fangsoft.testcenter.dao.impl.TestDaoImpl;
...
public class TestCenter {
	...
	public static TestResult takeTest(Test test, Customer customer) {
		...
		QuestionDaoImpl.getInstance().loadQuestion(test);
